...
func (m *MockChatRepository) SaveMessage(ctx context.Context, userID int64, content string) error {
	m.ctrl.T.Helper()
...
func (mr *MockChatRepositoryMockRecorder) SaveMessage(ctx, userID, content any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
